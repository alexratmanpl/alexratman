...
pages/
  ...
  learn/
    ...
    self-improving-skills/
      ...
      page.css              its page-specific styles
      app.js                its widgets + the live "where it stands" table
```
